...
var fullNormalize = pipe(flatten, chain(split(',')), map(trim), reject(isEmpty), map(tagNormalize), join(''));
...
var isSingleObject = results => results.length === 1 && is(Object, results[0]);
...
var Logger = (moduleName, ...rest) => {
  ...
  var disabledSubfn = _ref3;
  //eslint-disable-next-line
  var disabledLogger = (...tags) => disabledSubfn;
