...
export var strDecToHex = str => toLower(bigInt2str(str2bigInt(str, 10, 0), 16));
...
export function longToInts(sLong) {
  ...
  var resL = [~~bigInt2str(div, 10), ~~bigInt2str(rem, 10)];
  return resL;
}
...
export function rsaEncrypt(publicKey, bytes) {
  ...
  var X = str2bigInt(bytesToHex(bytes), 16, 256);
...
export function addPadding(bytes, blockSize = 16, zeroes) {
